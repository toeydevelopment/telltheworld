...
type Bootstrap struct {
	...
	TellerClient  *TellerClient          `protobuf:"bytes,3,opt,name=teller_client,json=tellerClient,proto3" json:"teller_client,omitempty"`
...
func (x *Bootstrap) GetTellerClient() *TellerClient {
	if x != nil {
		return x.TellerClient
	}
	return nil
}
...
type TellerClient struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Endpoint      string                 `protobuf:"bytes,1,opt,name=endpoint,proto3" json:"endpoint,omitempty"` // teller service gRPC endpoint
	Timeout       *durationpb.Duration   `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *TellerClient) Reset() {
	*x = TellerClient{}
...
func (x *TellerClient) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TellerClient) ProtoMessage() {}

func (x *TellerClient) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TellerClient.ProtoReflect.Descriptor instead.
func (*TellerClient) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3}
}

func (x *TellerClient) GetEndpoint() string {
	if x != nil {
		return x.Endpoint
	}
	return ""
...
func (x *TellerClient) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"kratos.api\x1a\x1egoogle/protobuf/duration.proto\"\x9c\x01\n" +
	"\tBootstrap\x12*\n" +
	"\x06server\x18\x01 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\x12=\n" +
	"\rteller_client\x18\x03 \x01(\v2\x18.kratos.api.TellerClientR\ftellerClient\"\xb8\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\fTellerClient\x12\x1a\n" +
	"\bendpoint\x18\x01 \x01(\tR\bendpoint\x123\n" +
	"\atimeout\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB0Z.github.com/toeydevelopment/telltheworld/apps/ecommerce/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	...
	(*TellerClient)(nil),        // 3: kratos.api.TellerClient
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	3,  // 2: kratos.api.Bootstrap.teller_client:type_name -> kratos.api.TellerClient
	...
	8,  // 7: kratos.api.TellerClient.timeout:type_name -> google.protobuf.Duration
